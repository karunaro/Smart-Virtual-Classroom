...
export const RetrieveCourses = createAsyncThunk(
  ...
  async () => {
    const { data } = await axios.get(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/course/");
...
export const RetrieveCoursesByIdSeance = createAsyncThunk(
  ...
  async (idSeance) => {
    const { data } = await axios.get(
        process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/course/findByIdSeances/" + idSeance
    );
...
export const AddCourses = (idSeance, Name, Description, files) => async (
  ...
  const promise = await axios
    .post(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/course/", formData)
    .then((response) => {
...
export const UpdateCourses = (
  ...
  const promise = await axios
    .put(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/course/" + coursesId, cour)
    .then((response) => {
      dispatch(RetrieveCourses());
      const data = response.data;
      console.log(data);
...
export const GetCoursesById = createAsyncThunk(
  ...
  async (coursesId) => {
    const promise = await axios
      .get(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/course/" + coursesId)
...
export const DeleteCourses = createAsyncThunk(
  ...
  async (coursesId) => {
    const promise = await axios
      .delete(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/course/" + coursesId)
