...
export const getSeances = createAsyncThunk("seance/getSeances", async () => {
  const { data } = await axios.get(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/seance");
...
export const AddSeances = createAsyncThunk(
  ...
  async (seances) => {
    const promise = await axios
      .post(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/seance/", seances)
...
export const GetSeancesById = createAsyncThunk(
  ...
  async (Id) => {
    const promise = await axios
      .get(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/seance/" + Id)
...
export const Editseances = createAsyncThunk(
  ...
  async (seances) => {
    ...
    const promise = await axios
      .put(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/seance/" + seances._id, seances)
...
export const Deleteseances = createAsyncThunk(
  ...
  async (Id) => {
    const promise = await axios
      .delete(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/seance/" + Id)
...
export const getseancesByIdClass = createAsyncThunk(
  ...
  async (idClass) => {
    const { data } = await axios.get(
        process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + "/seance/findByIdClasses/" + idClass
    );
