...
import ValidationsDisplay from '../../components/ValidationsDisplay'
import ModalAffectValidations from '../../components/ModalAffectValidations'
                        ...
                        <div className="table-responsive">
                            ...
                            >
                                ...
                                <tr className="text-left">
                                    ...
                                    <th style={{minWidth: "150px"}}>Mail Adress</th>
                                            ...
                                            <a
                                                onClick={() => {
                                                    setgroup((oldstate) => {
                                                        return {
                                                            ...oldstate,
                                                            members: oldstate.members.filter(mbr => mbr._id != member._id)
                                                        }
                                                    });
                                                    console.log(group);
                                                    axios.put(process.env.REACT_APP_BACKEND_PROTOCOL + process.env.REACT_APP_BACKEND_IP + ':' + process.env.REACT_APP_BACKEND_PORT + `/groups/deletememberfromgroup/` + group._id + '/' + member._id)
                                                }}
                                                className="btn btn-icon btn-light btn-hover-primary btn-sm"
                                            >
                    <span className="svg-icon svg-icon-md svg-icon-primary">
                        ...
                        <div className="table-responsive">
                            ...
                            >
                                ...
                                <tr className="text-left">
                                    ...
                                    <th style={{minWidth: "200px"}}/>
                                    <th style={{minWidth: "150px"}}>Mail Adresse</th>
                                    <th style={{minWidth: "150px"}}>progress</th>
                                    <th className="pr-0 text-right" style={{minWidth: "150px"}}>
                                        action
                                    </th>
