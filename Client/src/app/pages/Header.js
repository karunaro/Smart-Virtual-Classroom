        ...
        >
            ...
            <ul className={`menu-nav ${layoutProps.ulClasses}`}>
                ...
                <li
                    ...
                    aria-haspopup="true"
                    className={`menu-item menu-item-submenu menu-item-rel ${getMenuItemActive('/group')}`}>
                ...
                <div className="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul className="menu-subnav">
                        <li className={`menu-item ${getMenuItemActive('/Create New Quizz')}`}>
...
<<<<<<< Updated upstream
                ...
                data-menu-toggle={layoutProps.menuDesktopToggle}
                aria-haspopup="true"
                className={`menu-item menu-item-submenu menu-item-rel ${getMenuItemActive('/Meetopia')}`}>
                ...
                <div className="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul className="menu-subnav">
                        ...
                        {/*begin::2 Level*/}
                        <li className={`menu-item ${getMenuItemActive('/View My Meetopias')}`}>
...
>>>>>>> Stashed changes
        ...
        >
            ...
            <ul className={`menu-nav ${layoutProps.ulClasses}`}>
                ...
                <li className={`menu-item menu-item-rel ${getMenuItemActive('/Professors')}`}>
                    <NavLink className="menu-link" to="/Professors">
                        <span className="menu-text">Professors</span>
                        {layoutProps.rootArrowEnabled && (<i className="menu-arrow"/>)}
                    </NavLink>
